module ScheduleViewer
  ...
  def self.success(appointment)
    puts "Booked your #{appointment.class} apppointment from #{appointment.start_datetime.strftime('%I:%M%p')} to #{appointment.end_datetime.strftime('%I:%M%p')} with #{appointment.client_name}."
  end
